...
import com.affinity.efasample.SettingsManager;
...
public class GatewayActivity extends AppCompatActivity implements SessionDelegate {
...
//    //////////////////////////////////////////////////////  Overridden section : Session Delegation ////////////////////////
    ...
    public void paymentSucceed(@NonNull Charge charge) {
        ...
        startActivity(new Intent(GatewayActivity.this, CompleteActivity.class));
    }
