...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.CustomViewHolder> {
    ...
    public MyOrderAdapter(Context context, int[] images, String[] rate, String[] name, String[] brand) {
    ...
    public MyOrderAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.myorderlist_row, parent, false);

        return new MyOrderAdapter.CustomViewHolder(itView);
    }
